...
import static com.example.prodigy.litevervelife.BluetoothLeServiceMaster.UPDATE_DEVICE_NAME;
import static com.example.prodigy.litevervelife.BluetoothLeServiceMaster.UPDATE_SOUND;
 ...
 */
public class BluetoothLeServiceSlave extends Service implements IService{
    private final static String TAG = BluetoothLeServiceSlave.class.getSimpleName();
    ...
    public final static String ACTION_GATT_CONNECTED_SLAVE =
            "com.example.bluetooth.le.ACTION_GATT_CONNECTED_SLAVE";
    public final static String ACTION_GATT_DISCONNECTED_SLAVE =
            "com.example.bluetooth.le.ACTION_GATT_DISCONNECTED_SLAVE";
    public final static String ACTION_GATT_SERVICES_DISCOVERED_SLAVE =
            "com.example.bluetooth.le.ACTION_GATT_SERVICES_DISCOVERED_SLAVE";
    ...
    public final static String UPDATE_BATTERY =
            "com.example.bluetooth.le.Update_Battery_SLAVE";
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onConnectionStateChange(BluetoothGatt gatt, int status, int newState) {
            ...
            if (newState == BluetoothProfile.STATE_CONNECTED) {
                intentAction = ACTION_GATT_CONNECTED_SLAVE;
                mConnectionState = STATE_CONNECTED;
                broadcastUpdate(intentAction);
                Log.i(TAG, "Coinnected to GATT server.");
                // Attempts to discover services after successful connection.
               Log.i(TAG, "Attempting to start service discovery:" +     mBluetoothGatt.discoverServices()); //БЕЗ ЭТОГО ТУПИТ ПОЧЕМУ ?!!



            } else if (newState == BluetoothProfile.STATE_DISCONNECTED) {
                intentAction = ACTION_GATT_DISCONNECTED_SLAVE;
        ...
        public void onServicesDiscovered(BluetoothGatt gatt, int status) {
            if (status == BluetoothGatt.GATT_SUCCESS) {
                broadcastUpdate(ACTION_GATT_SERVICES_DISCOVERED_SLAVE);
            } else {
                Log.w(TAG, "onServicesDiscovered received: " + status);
            }
        }

        @Override  //асинхронное получение характеристик //
        ...
        @Override  //ИТог ОТПРАВКи ДАННЫХ НА наушники
        public void onCharacteristicWrite(BluetoothGatt gatt,
                                          BluetoothGattCharacteristic characteristic, int status) {
            //тут итоговый результат тез данных которое записало в себя устройство со статусом
    ...
    public class LocalBinder extends Binder {
        public BluetoothLeServiceSlave getService() {
            return BluetoothLeServiceSlave.this;
        }
    }
